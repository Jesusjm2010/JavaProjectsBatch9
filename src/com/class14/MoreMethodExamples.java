...
public class MoreMethodExamples {
	 ...
	 * and returns a double of that number
	 */
	...
	/*
	 * creat a method that takes a boolean as input
	 * if the value is true i want to print take the umbrella
	 * and if the value is false print please a go for a walk
	 * 
	 */
	
	void isRainig(boolean isRain) {
		if(isRain) {
		...
		/*
		 * write a method to print a batch 9 is great 5 times
		 */
		 ...
		 * sum of the elements that is present in the array
		 */
